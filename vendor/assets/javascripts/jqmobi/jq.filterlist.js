...
(function($) {
    ...
    var filterList = function(elem, opts) {
        ...
        var input = $("<input class='filterInput' type='text' placeholder='Buscar...' style='width:100%'/>");
        var wrapper = $("<div class='filterList' style='width:99%;height:30px;position:relative;'/>");
        var closer = $("<div class='filterClose' style='position:absolute;top:5px;right:10px;display:none'></div>");
